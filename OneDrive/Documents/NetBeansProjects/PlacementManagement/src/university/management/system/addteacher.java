...
public class addteacher extends JFrame implements ActionListener {
    ...
    addteacher() {
        ...
        empid.setFont(new Font("serif", Font.BOLD, 23));
        add(empid);

        empidip = new JLabel("101" + first4);
        empidip.setBounds(200, 200, 150, 30);
        empidip.setFont(new Font("serif", Font.BOLD, 30));
        add(empidip);
